                ...
                <SafeAreaView style={styles.wrapperView}>
                    ...
                    <View style={[styles.wrapperView, { alignItems: 'center' }]}>
                        <Image
                            ...
                            source={require('../../assets/Slizzer-icon/events2.png')} />

                        <Text style={[styles.textView1, { fontFamily: FONT.Nunito.bold, fontSize: 17 }]}>Uroojs Banger</Text>
                        <Text style={styles.textView1}>Prepaid |$5</Text>
                        <Text style={[styles.textView1, { color: '#F818D9' }]}>11:30 PM | Feb 25, 2020 - WED</Text>
                        <View style={{ flexDirection: 'row', marginBottom: 20 }}>
                            <Image
                                style={{ marginRight: 5 }} source={require('../../assets/Slizzer-icon/location.png')} />
                            <Text style={styles.textView1}>Toronto, ON</Text>
                        </View>
                        <Text style={styles.textView2}>Attendees on the List:
                                <Text style={styles.numValue}> 100</Text>
                        </Text>
                        <Text style={styles.textView2}>Attendes Scanned In:
                                <Text style={styles.numValue}> 86</Text>
                        </Text>
                        <Text style={styles.textView2}>Event Earnings:
                                <Text style={styles.numValue}> $430</Text>
                        </Text>
                        <Text style={styles.textView2}>Service Charges & Payout Fee ($2.25):
                                <Text style={styles.numValue}> $51.60</Text>
                        </Text>
                        <Text style={styles.textView2}>Total Event Earnings:
