  ...
  render() {
    return (
      <View style={styles.wrapperView}>
        ...
        <View style={{flexDirection:'row',justifyContent: 'space-between',marginHorizontal:10,height:70}}>
        ...
        <View style={{ overflow: 'hidden', paddingBottom: 5 }}>
          <View
            ...
            <TouchableOpacity
                style={
                  this.state.index == 0
                    ? { borderBottomColor: '#F818D9', borderBottomWidth: 3 ,borderColor:'lightgrey',justifyContent: 'center',borderWidth:1,width:SCREEN.width*0.2,height:39}
                    : { color: 'black' ,width:SCREEN.width*0.2,height:39,borderColor:'lightgrey',borderWidth:1,justifyContent: 'center'}
                }
            ...
            <TouchableOpacity
                 style={
                  this.state.index == 3
                    ? { borderBottomColor: '#F818D9', borderBottomWidth: 3 ,borderColor:'lightgrey',justifyContent: 'center',borderWidth:1,width:SCREEN.width*0.45,height:39}
                    : { color: 'black' ,width:SCREEN.width*0.45,height:39,borderColor:'lightgrey',borderWidth:1,justifyContent: 'center'}
                }
          ...
          {(this.state.index === 0  && this.state.listView === false )&& (
         this.enableLocation()
         )}
...
<View style={styles.bottomView}>
  ...
  <View
    ...
    <TouchableOpacity
      ...
      <View style={styles.input}>
       <View style={{flexDirection:'row',}}>
        ...
        <Text style={{ height:53, width:SCREEN.width*0.75,paddingLeft: 20,paddingTop:15,alignItems: 'center' ,fontFamily:FONT.Nunito.semiBold,fontSize:16}}>
          Thursday, August 24, 2020
        </Text>
       <View style={{height:53,width:1,backgroundColor:'lightgrey'}}></View>
        </View>
        <Image
    ...
    <TouchableOpacity style={styles.btnMap} onPress={()=>this.setState({mapView:false,listView:true})}>
      <Text style={styles.btnText}>List View</Text>
    </TouchableOpacity>
      }
    {this.state.listView == true &&
   
    <TouchableOpacity style={styles.btnMap} onPress={()=>this.setState({listView:false,mapView:true})}>
