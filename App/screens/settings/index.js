        ...
        return (
            <View style={styles.wrapperview}>
                <SafeAreaView style={styles.contentView}>
                    ...
                    <Text style={styles.lowerText}>Allow location to turn on and set the radius to find nearby events or people</Text>
                    ...
                    trackStyle={{height: 2, backgroundColor: '#F818D9'}}
                    thumbStyle={{ height: 20, width: 20, backgroundColor:'#F818D9'}}
                    />

                    <View style={styles.verticalView}>
                        <View style={[styles.rowView,{borderTopColor:'lightgrey',borderTopWidth:1}]}>
                        ...
                        <View style={styles.rowView}>
                            <Text style={styles.textView}>Profile Visibility in People Radar</Text>
                            <Image
                            style={[styles.icon,{width: 55, height: 37}]} 
                        ...
                        <View style={[styles.rowView,{borderBottomWidth:0}]}>
                            <Text style={[styles.textView,{color:'#FF2D55',fontWeight: '700'}]}>Remove Account</Text>
                            <Image
                            style={styles.icon} 
                            source={require('../../assets/Slizzer-icon/Right.png')}/>
                        </View>
