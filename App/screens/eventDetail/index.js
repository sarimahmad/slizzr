          ...
          <ScrollView bounces={false}>
            ...
            <View style={{ width: SCREEN.width - 40, alignSelf: 'center' }}>
              ...
              <View style={[styles.flexRow, { paddingTop: 8 }]}>
                ...
                <Text style={[styles.purpleText, { textDecorationLine: 'underline', fontFamily: FONT.Nunito.regular, paddingLeft: 4 }]}>{this.state.detailItem.Host !== undefined && this.state.detailItem.Host.displayName}</Text>
              </View>
              <Text style={{ fontFamily: FONT.Nunito.bold, fontSize: 12, color: BLACK.textColor3, marginTop: 3, fontWeight: 'bold' }}>{moment(this.state.detailItem.datetime).format('hh:mm A | MMM DD, YYYY - ddd')} | {this.state.detailItem.duration} HRS</Text>
              <View style={[styles.flexRow, { justifyContent: 'space-between' }]}>
                ...
                <Text style={{ fontFamily: FONT.Nunito.bold, fontSize: 17, color: BLACK.textColor2 }}>{this.state.detailItem.EventType !== 'FREE' && `$${this.state.detailItem.Fee}`}</Text>
              </View>
              <Text style={[styles.titleText, { marginTop: 9 }]}>Mutual Attendees</Text>
